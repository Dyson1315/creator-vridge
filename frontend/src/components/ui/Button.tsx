...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading = false, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary-400 hover:bg-primary-500 text-white focus:ring-primary-400 shadow-soft',
      secondary: 'bg-secondary-400 hover:bg-secondary-500 text-white focus:ring-secondary-400 shadow-soft',
      outline: 'border-2 border-primary-400 text-primary-400 hover:bg-primary-50 focus:ring-primary-400',
      ghost: 'text-calm-600 hover:bg-calm-100 focus:ring-calm-400',
    };
